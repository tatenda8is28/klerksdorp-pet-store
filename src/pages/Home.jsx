  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="bg-[#004694] overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 h-[450px] lg:h-[600px] w-full relative">
            ...
            {/* MOBILE ONLY BUTTON (Hidden on desktop, centered over photo) */}
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 w-full flex-grow">
        ...
        {/* BOTTOM VISIT STORE BUTTON (Shown for everyone before footer) */}
        <div className="flex justify-center md:justify-end border-t border-gray-100 pt-16">
          <Link to="/store" className="group flex items-center gap-4 bg-[#004694] text-white pl-10 pr-6 py-5 rounded-[25px] font-black uppercase italic tracking-tighter hover:bg-blue-800 transition-all shadow-2xl">
            Go to Full Store
